...
public class LandRegistryServiceImpl {
    ...
    public List<Address> getLandRegistryDataByPostCode(String postCode) throws UnirestException, IOException {
    ...
    private List<Address> getPositionForAddresses(List<Address> addresses) {
